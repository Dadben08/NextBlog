  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-20 '>
        ...
        <div className='text-center my-8' >
            ...
            <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, velit nisi. Quod, obcaecati iste? Error sit dignissimos ipsum vitae, repellendus deleniti maiores ducimus facere, necessitatibus animi deserunt delectus, odit adipisci.</p>
